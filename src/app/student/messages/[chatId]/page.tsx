...
function formatTime(value: Timestamp | Date | null) {
...
export default function StudentChatPage() {
     ...
     * ---------------------------------------------------------
     * CURRENT TIME
     * Refresh every 30 seconds so an expired session updates
